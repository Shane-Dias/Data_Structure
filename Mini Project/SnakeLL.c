...
#define yaxis 20 // Map size y-axis14
...
enum Direction
{
    ...
    LEFT,
    RIGHT
}; // user-define constant (replace numerical values with string values)
enum Direction dir;
...
{ // printing on screen only
    ...
    {
        saveRecord();
        printf("Your score have been saved, thank you");
